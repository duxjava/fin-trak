...
export default function CreateAccountModal({ isOpen, onClose, groupId, onSuccess }: CreateAccountModalProps) {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-900">Создать счет</h3>
            <button
              onClick={onClose}
